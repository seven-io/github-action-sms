...
exports["default"] = (function (params) {
    ...
    exports.label(params.label);
    exports.text(params.text);
    exports.to(params.to);
    exports.ttl(params.ttl);
});
...
var label = function (label) {
    ...
    if (label.match(exports.LABEL_PATTERN)) {
        throw new Error("label must match the regex pattern " + exports.LABEL_PATTERN + ".");
    }
...
var text = function (text) {
    ...
    if (exports.TEXT_MAX_LENGTH < text.length) {
        throw new Error("The text cannot be longer than " + exports.TEXT_MAX_LENGTH + " characters.");
    }
};
exports.text = text;
var to = function (to) {
...
var ttl = function (ttl) {
    ...
    if (ttl < exports.TTL_MIN) {
        throw new Error("ttl must be at least " + exports.TTL_MIN + ".");
    }
    if (ttl > exports.TTL_MAX) {
        throw new Error("ttl may not exceed " + exports.TTL_MAX + ".");
    }
};
exports.ttl = ttl;
